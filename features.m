...
%        end
   ...
   %below center
	...
	fprintf(f1,'%d,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f\n',k,angle_above_left_xy1,angle_above_left_xy2,angle_above_left_xy3,angle_above_left_xy4,angle_above_right_xy1,angle_above_right_xy2,angle_above_right_xy3,angle_above_right_xy4,angle_below_left_xy1,angle_below_left_xy2,angle_below_left_xy3,angle_below_left_xy4,angle_below_right_xy1,angle_below_right_xy2,angle_below_right_xy3,angle_below_right_xy4,angle_above_left_yz1,angle_above_left_yz2,angle_above_left_yz3,angle_above_left_yz4,angle_above_right_yz1,angle_above_right_yz2,angle_above_right_yz3,angle_above_right_yz4,angle_below_left_yz1,angle_below_left_yz2,angle_below_left_yz3,angle_below_left_yz4,angle_below_right_yz1,angle_below_right_yz2,angle_below_right_yz3,angle_below_right_yz4,angle_above_left_zx1,angle_above_left_zx2,angle_above_left_zx3,angle_above_left_zx4,angle_above_right_zx1,angle_above_right_zx2,angle_above_right_zx3,angle_above_right_zx4,angle_below_left_zx1,angle_below_left_zx2,angle_below_left_zx3,angle_below_left_zx4,angle_below_right_zx1,angle_below_right_zx2,angle_below_right_zx3,angle_below_right_zx4);
...
function agle=angle(a,b)
  agle=acos(dot(a,b)/((norm(a))*(norm(b))))*180/pi;
  t=cross([a;0],[b;0]);
  if t(3)<0
     agle=360.0-agle; 
  end
